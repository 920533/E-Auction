    ...
    public class DtoMapper : Profile
    {
        ...
        public DtoMapper()
        {
            CreateMap<Product, ProductDto>()
                .ForMember(dest => dest.ProductId, action => action.Ignore())
                .ForMember(dest => dest.ProductName, action => action.MapFrom(src => src.ProductName))
                .ForMember(dest => dest.ShortDescription, action => action.MapFrom(src => src.ShortDescription))
                .ForMember(dest => dest.DetailedDescription, action => action.MapFrom(src => src.DetailedDescription))
            ...
            CreateMap<ProductToBuyer, ProductToBuyerDto>()
                .ForMember(dest => dest.BuyerProductId, action => action.Ignore())
            ...
            CreateMap<User, UserDto>()
                .ForMember(dest => dest.UserId, action => action.Ignore())
